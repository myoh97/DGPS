...
class CUHK_SYSU(PersonSearchDataset):
    ...
    def gt_roidb(self):
        ...
        if self.mode != 'train':
            if osp.isfile('pickles/cuhk_test.pickle'):    
                with open('pickles/cuhk_test.pickle', 'rb') as f:
                    gt_roidb = pickle.load(f)
                    print('load cuhk_test.pickle done')
                return gt_roidb
        ...
        # if self.mode != 'train':
        #     with open('cuhk_test.pickle', 'wb') as f:
    ...
    def _load_image_set_index(self):
        ...
        images = sorted(list(set(all_imgs) - set(test)))
        return images
    ...
    def search_performance_calc(gallery_set, probe_set,
                                ...
                                det_thresh=0.5, gallery_size=100, ignore_cam_id=False, remove_unlabel=False):
        """
